  ...
  return (
    ...
    <div className="card">
      ...
      <button onClick={handleClick} type="button" className="card__button">
        <img className="card__image" alt="Изображение места" src={props.card.link} />
      </button>

    <button onClick={handleCardDelete} type="button" className={props.cardDeleteButtonClassName}></button>
          ...
          <h3 className="card__item-subtitle">{props.card.name}</h3>
            <div className="card__board">
              <button onClick={handleLikeClick} type="button" className="card__item-button">
                <svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg" className={props.cardLikeButtonClassName}>
